                        ...
                        {order.products.map((orderItem: OrderItemType) => (
                            <div className='flex gap-4'>
                                ...
                                <div className='flex flex-col justify-between'>
                                    ...
                                    {orderItem.color && (
                                    <p className='text-small-medium'>Color:{" "} <span className='text-small-bold'>{orderItem.color}</span></p>
                                )}

                                    {orderItem.size && (
                                    <p className='text-small-medium'>Size:{" "} <span className='text-small-bold'>{orderItem.size}</span></p>
                                )}
